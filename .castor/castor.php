...
use TheoD\ApiPlatformFiltersPOC\Docker\DockerUtils;
...
use function TheoD\ApiPlatformFiltersPOC\delayed_fingerprint;
use function TheoD\ApiPlatformFiltersPOC\docker;
use function TheoD\ApiPlatformFiltersPOC\fgp;
use function TheoD\ApiPlatformFiltersPOC\Runner\composer;
use function TheoD\ApiPlatformFiltersPOC\Runner\pnpm;
use function TheoD\ApiPlatformFiltersPOC\Runner\qa;
use function TheoD\ApiPlatformFiltersPOC\Runner\symfony;
...
{
    symfony()->console('doctrine:database:drop', '--force')->run();
