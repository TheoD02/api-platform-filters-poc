...
/**
 * @see \App\Tests\ApiPlatform\Filter\Operator\NotContainsOperatorTest
 */
class NotContainsOperator implements OrmOperatorInterface, StringOperatorInterface
{
    ...
    {
        return 'not partial string match';
    }
