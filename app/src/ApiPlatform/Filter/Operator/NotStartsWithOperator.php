...
/**
 * @see \App\Tests\ApiPlatform\Filter\Operator\NotStartsWithOperatorTest
 */
class NotStartsWithOperator implements OrmOperatorInterface, StringOperatorInterface
{
    ...
    {
        return 'not partial string match at the beginning';
    }
