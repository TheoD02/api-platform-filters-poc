...
/**
 * @see \App\Tests\ApiPlatform\Filter\Operator\LessThanOrEqualOperatorTest
 */
class LessThanOrEqualsOperator implements OrmOperatorInterface, NumberOperatorInterface
{
    ...
    {
        return 'less than or equal to a value';
    }
