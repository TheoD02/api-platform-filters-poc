...
/**
 * @see \App\Tests\ApiPlatform\Filter\Operator\InOperatorTest
 */
class InOperator implements OrmOperatorInterface, NumberOperatorInterface, StringOperatorInterface, ArrayOperatorInterface
{
    ...
    public function apply(QueryBuilder $qb, string $rootAlias, string|array $value, \ReflectionProperty|FilterDefinition $filterDefinition): QueryBuilder
    {
        ...
        return $qb->andWhere(sprintf('%s.%s IN (:%s)', $rootAlias, $filterDefinition->getName(), $parameterName))
