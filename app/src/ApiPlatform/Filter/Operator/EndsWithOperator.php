...
/**
 * @see \App\Tests\ApiPlatform\Filter\Operator\EndsWithOperatorTest
 */
class EndsWithOperator implements OrmOperatorInterface, StringOperatorInterface
{
    ...
    {
        return 'partial string match at the end';
    }
