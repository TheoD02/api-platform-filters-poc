...
/**
 * @see \App\Tests\ApiPlatform\Filter\Operator\GreaterThanOperatorTest
 */
class GreaterThanOperator implements OrmOperatorInterface, NumberOperatorInterface
{
