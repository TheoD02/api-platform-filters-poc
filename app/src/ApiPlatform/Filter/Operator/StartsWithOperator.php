...
/**
 * @see \App\Tests\ApiPlatform\Filter\Operator\StartsWithOperatorTest
 */
class StartsWithOperator implements OrmOperatorInterface, StringOperatorInterface
{
    ...
    {
        return 'partial string match at the beginning';
    }
